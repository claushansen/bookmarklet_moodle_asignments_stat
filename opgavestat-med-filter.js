...
function makeInfo() {
    ...
    var infoText = '<h4>' + student + ' har afleveret ' + antalAfleverede + ' ud af ' + antalOpgaver + filtertekst + ' opgaver.</h4>';
...
function makeInfoBox() {
    ...
    var inforesult = $('<div id="opgaveresult" class="col-6 pull-left"></div><div id="piechart" class="col-6 pull-right" style="width: 500px; height: 500px;"></div><div style="clear:both;"></div>');
